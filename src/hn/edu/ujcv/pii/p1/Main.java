...
public class Main {
    ...
    private static ListaAlumnos        _listaAlumnos      = new ListaAlumnos();
    private static ListaCampus         _listaCampus       = new ListaCampus();
    private static ListaCarreras       _listaCarreras     = new ListaCarreras();
    private static ListaCatedraticos   _listaCatedraticos = new ListaCatedraticos();
    private static ListaClases         _listaClases       = new ListaClases();
    private static ListaPeriodos       _listaPeriodos     = new ListaPeriodos();
    private static ListaHistoriales    _listaHistoriales  = new ListaHistoriales();

    private static void agregarAlumno(Scanner entrada){
        System.out.println("\n\n>> Alumno <<\n\n");
        ...
        try {
            ...
            _listaHistoriales.AddHistorial(new Historial(_tempAlumno, agregarCampus(entrada), agregarCarrera(entrada), agregarPeriodo(entrada), agregarClases(entrada)));
    ...
    //****************************************************
    private static Campus agregarCampus(Scanner entrada){
    ...
    //****************************************************
    private static Carrera agregarCarrera(Scanner entrada){
        while(true){
            try {
                System.out.println("\n>> Carrera <<\n");
    ...
    //****************************************************
    private static Catedratico agregarCatedratico(Scanner entrada){
    ...
    //****************************************************
    private static Periodo agregarPeriodo(Scanner entrada){
    ...
    //****************************************************
    private static ArrayList<Clase> agregarClases(Scanner entrada){
    ...
    public static void main(String[] args) {
        ...
        do{
            try{
                ...
                System.out.println(">>> Igrese opción: ");
